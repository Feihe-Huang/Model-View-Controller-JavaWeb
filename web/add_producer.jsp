...
<div class="user">
    <header class="user__header">
        <h2 class="user__title">Upload Producer Info...</h2>
    </header>

    <form action="add_producer.jsp" method="post" class="form" >
        <div class="form__group">
            <input type="text" placeholder="Producer ID" name="pro_id" required = "required" class="form__input" />
        </div>
        ...
        <div class="form__group">
            <input type="text" placeholder="Amount" name="pro_amount" required = "required" class="form__input" />
        </div>

        <div class="form__group">
            <input type="text" placeholder="Likes" name="pro_likes"required = "required" class="form__input" />
        </div>

        <div class="form__group">
            <input type="text" placeholder="Tel" name="pro_tel"required = "required" class="form__input" />
        </div>
        ...
        <% Connection conn=null;
            ...
            String dbName="art_gallery?useUnicode=true&characterEncoding=utf8";
            ...
            try{  Class.forName(driver).newInstance();
                ...
                if(request.getParameter("Upload")!= null){
                    ...
                    conn = DriverManager.getConnection(url+dbName,"root", "hfh102938");
                    PreparedStatement pst =(PreparedStatement) conn.prepareStatement("insert into producer values(?,?,?,?,?)");//try2 is the name of the table
